...
networks_map = {'alexnet_v2': alexnet.alexnet_v2,
                ...
                'flownet_s':flownet.flownet_s,
                'flownet_si':flownet.flownet_si,
                'flownet_c':flownet.flownet_c,
               }
...
arg_scopes_map = {'alexnet_v2': alexnet.alexnet_v2_arg_scope,
                  ...
                  'flownet_s':flownet.flownet_arg_scope,
                  'flownet_si':flownet.flownet_arg_scope,
                  'flownet_c':flownet.flownet_arg_scope,
                 }
...
def get_network_fn(name, num_classes, weight_decay=0.0, is_training=False):
  ...
  def network_fn(image_a, image_b, **kwargs):
    ...
    with slim.arg_scope(arg_scope):
      return func(image_a, image_b, num_classes, is_training=is_training, **kwargs)
